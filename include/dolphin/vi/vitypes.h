#ifndef DOLPHIN_VI_VITYPES_H
#define DOLPHIN_VI_VITYPES_H

// VI enumerations needed by the GX headers (GXRenderModeObj embeds a VITVMode
// and a VIXFBMode). Ported from the Dolphin SDK. The video driver itself
// (src/dolphin/vi/vi.c) is self-contained and does not include this header, so
// there is no clash with its private declarations.
