...
//
// The translation unit runs from fn_8_0 at 0x0 to the end of _prolog at 0xD8.
...
// straight out of the module. fn_8_0 is the empty function the table at
...
extern ModuleEntry lbl_8_data_10[];
extern u8 lbl_8_data_F8[];
extern u8 lbl_8_data_11B8[];
...
void _prolog(void)
{
	...
	fn_800421B4(lbl_8042C1C0, lbl_8_data_10);
	lbl_8029C310.unk30 = lbl_8_data_11B8;
	lbl_8029C310.unk38 = lbl_8_data_F8;
	fn_8_D29EC();
}
