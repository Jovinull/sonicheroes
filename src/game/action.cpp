	...
	switch (*(u32*)(param_1 + 0xc)) {
		...
		case 0xb:
			...
			fn_800421C8((u8*)&lbl_8042C1C0, (u32)stageSet);
			{
				RawTask** task;
				s32 i;
				DAT_8029c330 = (s32)(stageSet = (void*)(i = 0));
				task         = lbl_80303DC8;
				do {
