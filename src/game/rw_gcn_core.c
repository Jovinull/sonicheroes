...
s32 fn_80232A9C(u8* arg0)
{
	...
	var_r29  = 0;
	while (var_r30 < (s32)M2C_FIELD(temp_r31, s32*, 0x14)) {
		temp_r12 = (u32 (*)(M2C_UNK, u8*, M2C_UNK))
...
#pragma dont_inline on
u8* fn_80238444(s32 arg0, u8* arg1, s32* arg2)
{
	s32 sp8;
	u8* temp_r29;
	u8* temp_r29_2;
...
#pragma dont_inline on
u8* fn_802388D4(s32 arg0, u8* arg1, s32* arg2)
{
	s32 sp8;
	u8* temp_r29;
	u8* temp_r29_2;
...
u8* fn_802395BC(u8* arg0)
{
	u8* temp_r3;
	s32 temp_r3_2;
	u8* var_r29;

	temp_r3 = fn_80232968(arg0);
	var_r29 = NULL;
	if (temp_r3 != NULL) {
