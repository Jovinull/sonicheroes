...
//
// The translation unit runs from fn_10_0 at 0x0 to the end of _prolog at 0xD8.
...
// straight out of the module. fn_10_0 is the empty function the table at
...
extern ModuleEntry lbl_10_data_10[];
extern u8 lbl_10_data_F8[];
extern u8 lbl_10_data_1148[];
extern void fn_800421B4(void* arg0, ModuleEntry* arg1);
extern void fn_10_7D088(void);
...
void _prolog(void)
{
	...
	fn_800421B4(lbl_8042C1C0, lbl_10_data_10);
	lbl_8029C310.unk30 = lbl_10_data_1148;
	lbl_8029C310.unk38 = lbl_10_data_F8;
	fn_10_7D088();
}
