...
// Functions are ordered memset, __fill_mem, memcpy because this compiler emits
// them in source order and that is how they sit in the original binary.

DECL_SECT(".init") void* memset(void* dst, int val, u32 n);
DECL_SECT(".init") void __fill_mem(void* dst, int val, u32 n);
DECL_SECT(".init") void* memcpy(void* dst, const void* src, u32 n);
