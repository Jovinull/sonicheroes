...
// The record that registers NO OTTOTTO COLLISION with the editor.
//
// The claim is .text 0xD6000 to 0xD6098 and the .ctors word at 0x16C that names
...
extern "C" void noOttottoCollisionRegister(void)
{
	...
	noOttottoCollisionEntry.unk10  = NULL;
	...
	if (noOttottoCollisionEntry.fieldTypes != NULL) {
