...
// IronContainer's sound hook. It plays one cue through the sound handle
// when that handle is live, and does nothing otherwise.
//
// The claim is .text 0x00014784 to 0x000147C4 and nothing else. It
...
// ironContainerRegister in that family's block, and rel/obj_box_trigger.cpp already
...
extern "C" void ironContainerPlaySound(void)
{
