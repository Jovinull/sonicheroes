...
void __ct__10DAnimClassFv(void* obj, int n);
...
ADV_MAINMENU* fn_1_4E9C(ADV_MAINMENU* obj, void* parent)
{
	...
	*(s32*)((char*)obj + 0x3b8)  = 0;
	...
	fn_1_3B28(obj);
	__ct__10DAnimClassFv(obj, 5);
	__ct__10DAnimClassFv(obj, 6);
	__ct__10DAnimClassFv(obj, 7);
	__ct__10DAnimClassFv(obj, 0xb);
	__ct__10DAnimClassFv(obj, 0xa);
	__ct__10DAnimClassFv(obj, 9);
	__ct__10DAnimClassFv(obj, 1);
	return obj;
}
