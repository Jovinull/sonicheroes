...
// __ct__7TObjectFP7TObject / __dt__7TObjectFv).
struct TAdvBar {
	/* 0x00 */ void* name;
...
extern void __ct__7TObjectFP7TObject(void* self);
extern void __dt__7TObjectFv(void* self, s32 flag);
