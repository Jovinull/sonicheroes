...
//
// The translation unit runs from fn_6_0 at 0x0 to the end of _prolog at 0xD8.
...
// straight out of the module. fn_6_0 is the empty function the table at
...
extern ModuleEntry lbl_6_data_10[];
extern u8 lbl_6_data_F8[];
extern u8 lbl_6_data_1200[];
extern void fn_800421B4(void* arg0, ModuleEntry* arg1);
extern void fn_6_EE4A8(void);
...
void _prolog(void)
{
	...
	fn_800421B4(lbl_8042C1C0, lbl_6_data_10);
	lbl_8029C310.unk30 = lbl_6_data_1200;
	lbl_8029C310.unk38 = lbl_6_data_F8;
	fn_6_EE4A8();
}
