...
//
// The translation unit runs from fn_12_0 at 0x0 to the end of _prolog at 0xD8.
...
// straight out of the module. fn_12_0 is the empty function the table at
...
extern ModuleEntry lbl_12_data_10[];
extern u8 lbl_12_data_F8[];
extern u8 lbl_12_data_1130[];
extern void fn_800421B4(void* arg0, ModuleEntry* arg1);
extern void fn_12_80C38(void);
...
void _prolog(void)
{
	...
	fn_800421B4(lbl_8042C1C0, lbl_12_data_10);
	lbl_8029C310.unk30 = lbl_12_data_1130;
	lbl_8029C310.unk38 = lbl_12_data_F8;
	fn_12_80C38();
}
