...
#define OSSecondsToTicks(seconds) ((OSTime)((u32)(seconds) * OS_TIMER_CLOCK))
#define OSMillisecondsToTicks(milliseconds)                                                        \
	((OSTime)((u32)(milliseconds) * (OS_TIMER_CLOCK / 1000)))
#define OSMicrosecondsToTicks(microseconds)                                                        \
	((OSTime)((u32)(microseconds) * (OS_TIMER_CLOCK / 125000) / 8))
...
typedef void (*DVDLowCallback)(u32 interruptType);
...
static inline void WaitBeforeRead(
    void* addr, u32 length, u32 offset, DVDLowCallback callback, OSTime timeout)
{
	CommandList[0].cmd      = 1;
...
BOOL DVDLowRead(void* addr, u32 length, u32 offset, DVDLowCallback callback)
{
	...
	ASSERTMSGLINE(0x341, (((u32)addr) & 31) == 0,
...
{
	ASSERTMSGLINE(0x3d2, (((u32)diskID) & 31) == 0,
