...
// GX performance-metric setup, 0x801F7910 to 0x801F8168. Transcribed from the
// Apr 2003 Dolphin SDK (GXPerf.c). This dead-strip subset keeps only
// GXSetGPMetric and GXClearGPMetric; the intervening GXReadGPMetric and the
// trailing readers were stripped.
...
void GXSetGPMetric(GXPerf0 perf0, GXPerf1 perf1)
{
	...
	switch (__GXData->perf0) {
		case GX_PERF0_VERTICES:
			ASSERTMSGLINE(258, 0,
			    "The use of GX_PERF0_VERTICES is prohibited. Use GX_PERF1_VERTICES instead.\n");
			reg = 0x273;
			GX_WRITE_XF_REG(6, reg);
			break;
		case GX_PERF0_CLIP_VTX:
