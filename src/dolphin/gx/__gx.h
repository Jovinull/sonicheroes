...
// This is a release build (no debugger); the SDK assert macros compile away.
#ifndef ASSERTMSGLINE
#define ASSERTLINE(line, cond)                ((void)0)
#define ASSERTMSGLINE(line, cond, msg)        ((void)0)
#define ASSERTMSGLINEV(line, ...)             ((void)0)
#define ASSERTMSG1LINE(line, cond, msg, a)    ((void)0)
#define ASSERTMSG2LINE(line, cond, msg, a, b) ((void)0)
#endif
