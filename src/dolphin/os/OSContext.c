...
#define GQR1 SPR_GQR1
#define GQR2 SPR_GQR2
#define GQR3 SPR_GQR3
#define GQR4 SPR_GQR4
#define GQR5 SPR_GQR5
#define GQR6 SPR_GQR6
#define GQR7 SPR_GQR7

#define EXCEPTION_FLOATING_POINT 7
#define OS_CONTEXT_STATE_FPSAVED 1u

#ifdef __MWERKS__
extern OSContext* OS_PHYSICAL_CONTEXT : 0x800000C0;
extern OSContext* OS_CURRENT_CONTEXT : 0x800000D4;
extern OSContext* OS_CURRENT_FPU_CONTEXT : 0x800000D8;
#else
extern OSContext* OS_PHYSICAL_CONTEXT;
extern OSContext* OS_CURRENT_CONTEXT;
extern OSContext* OS_CURRENT_FPU_CONTEXT;
#endif

#define __OSFPUContext OS_CURRENT_FPU_CONTEXT
...
// clang-format off
    ...
    lfd f0, OSContext.fpscr_pad(context)
    mtfsf 0xFF, f0
    mfspr r5, 0x398
    rlwinm. r5, r5, 3, 0x1F, 0x1F
    beq load_fprs

    psq_l f0,  OSContext.psf[0](context), 0, 0
    psq_l f1,  OSContext.psf[1](context), 0, 0
    psq_l f2,  OSContext.psf[2](context), 0, 0
    psq_l f3,  OSContext.psf[3](context), 0, 0
    psq_l f4,  OSContext.psf[4](context), 0, 0
    psq_l f5,  OSContext.psf[5](context), 0, 0
    psq_l f6,  OSContext.psf[6](context), 0, 0
    psq_l f7,  OSContext.psf[7](context), 0, 0
    psq_l f8,  OSContext.psf[8](context), 0, 0
    psq_l f9,  OSContext.psf[9](context), 0, 0
    psq_l f10, OSContext.psf[10](context), 0, 0
    psq_l f11, OSContext.psf[11](context), 0, 0
    psq_l f12, OSContext.psf[12](context), 0, 0
    psq_l f13, OSContext.psf[13](context), 0, 0
    psq_l f14, OSContext.psf[14](context), 0, 0
    psq_l f15, OSContext.psf[15](context), 0, 0
    psq_l f16, OSContext.psf[16](context), 0, 0
    psq_l f17, OSContext.psf[17](context), 0, 0
    psq_l f18, OSContext.psf[18](context), 0, 0
    psq_l f19, OSContext.psf[19](context), 0, 0
    psq_l f20, OSContext.psf[20](context), 0, 0
    psq_l f21, OSContext.psf[21](context), 0, 0
    psq_l f22, OSContext.psf[22](context), 0, 0
    psq_l f23, OSContext.psf[23](context), 0, 0
    psq_l f24, OSContext.psf[24](context), 0, 0
    psq_l f25, OSContext.psf[25](context), 0, 0
    psq_l f26, OSContext.psf[26](context), 0, 0
    psq_l f27, OSContext.psf[27](context), 0, 0
    psq_l f28, OSContext.psf[28](context), 0, 0
    psq_l f29, OSContext.psf[29](context), 0, 0
    psq_l f30, OSContext.psf[30](context), 0, 0
    psq_l f31, OSContext.psf[31](context), 0, 0
...
// clang-format off
    ...
    mffs f0
    stfd f0, OSContext.fpscr_pad(context)
    lfd f0, OSContext.fpr[0](context)
    mfspr r3, 0x398
    rlwinm. r3, r3, 3, 0x1f, 0x1f
    beq exit

    psq_st f0,  OSContext.psf[ 0](context), 0, 0
    psq_st f1,  OSContext.psf[ 1](context), 0, 0
    psq_st f2,  OSContext.psf[ 2](context), 0, 0
    psq_st f3,  OSContext.psf[ 3](context), 0, 0
    psq_st f4,  OSContext.psf[ 4](context), 0, 0
    psq_st f5,  OSContext.psf[ 5](context), 0, 0
    psq_st f6,  OSContext.psf[ 6](context), 0, 0
    psq_st f7,  OSContext.psf[ 7](context), 0, 0
    psq_st f8,  OSContext.psf[ 8](context), 0, 0
    psq_st f9,  OSContext.psf[ 9](context), 0, 0
    psq_st f10, OSContext.psf[10](context), 0, 0
    psq_st f11, OSContext.psf[11](context), 0, 0
    psq_st f12, OSContext.psf[12](context), 0, 0
    psq_st f13, OSContext.psf[13](context), 0, 0
    psq_st f14, OSContext.psf[14](context), 0, 0
    psq_st f15, OSContext.psf[15](context), 0, 0
    psq_st f16, OSContext.psf[16](context), 0, 0
    psq_st f17, OSContext.psf[17](context), 0, 0
    psq_st f18, OSContext.psf[18](context), 0, 0
    psq_st f19, OSContext.psf[19](context), 0, 0
    psq_st f20, OSContext.psf[20](context), 0, 0
    psq_st f21, OSContext.psf[21](context), 0, 0
    psq_st f22, OSContext.psf[22](context), 0, 0
    psq_st f23, OSContext.psf[23](context), 0, 0
    psq_st f24, OSContext.psf[24](context), 0, 0
    psq_st f25, OSContext.psf[25](context), 0, 0
    psq_st f26, OSContext.psf[26](context), 0, 0
    psq_st f27, OSContext.psf[27](context), 0, 0
    psq_st f28, OSContext.psf[28](context), 0, 0
    psq_st f29, OSContext.psf[29](context), 0, 0
    psq_st f30, OSContext.psf[30](context), 0, 0
    psq_st f31, OSContext.psf[31](context), 0, 0
...
{
	__OSSetExceptionHandler(EXCEPTION_FLOATING_POINT, (__OSExceptionHandler)OSSwitchFPUContext);
	__OSFPUContext = NULL;
