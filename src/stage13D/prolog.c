...
//
// The translation unit runs from fn_9_0 at 0x0 to the end of _prolog at 0xD8.
...
// straight out of the module. fn_9_0 is the empty function the table at
// .data 0x0 registers, and nothing else in the module refers to it.
//
...
// reads the one at .data 0x0, but the sixteen bytes in front of it belong to
...
extern ModuleEntry lbl_9_data_0[];
extern u8 lbl_9_data_E8[];
extern u8 lbl_9_data_1248[];
extern void fn_800421B4(void* arg0, ModuleEntry* arg1);
extern void fn_9_DB630(void);
...
void _prolog(void)
{
	...
	fn_800421B4(lbl_8042C1C0, lbl_9_data_0);
	lbl_8029C310.unk30 = lbl_9_data_1248;
	lbl_8029C310.unk38 = lbl_9_data_E8;
	fn_9_DB630();
}
